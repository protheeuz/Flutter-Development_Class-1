...
void main(){
  group("BookService", (){
    ...
    test("Find book by id iqbal123", (){
      when(bookRepository.findById(argThat(startsWith("iqbal"))))
          .thenReturn(Book("iqbal123", "Tutorial Dart", 100000));

      var book = bookService.find("iqbal123");
      expect(book, equals(Book("iqbal123", "Tutorial Dart", 100000)));
